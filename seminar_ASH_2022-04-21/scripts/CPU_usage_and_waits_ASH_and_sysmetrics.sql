...
--======================================================================================
select begin_time
,sum(case when metric_name='Host CPU Usage Per Sec' then Round(value/100) end) "Host CPU Usage Per Sec,sec" 
...
,sum(case when metric_name='Average Synchronous Single-Block Read Latency' then Round(value,4) end) "Average Synchronous Single-Block Read Latency,ms" 
...
WHERE 1=1
  ...
  and SES.SAMPLE_TIME>sysdate-1/24 -- последний час
